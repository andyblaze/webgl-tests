export default class Registry {
    static init(three) {
        Registry.geometries = {
            sphere: { ctor: three.SphereGeometry, defaults: [6, 128, 64] },
            box: { ctor: three.BoxGeometry, defaults: [6, 6, 6] },
            torus: { ctor: three.TorusGeometry, defaults: [4, 1.5, 64, 128] },
            torusknot: { ctor: three.TorusKnotGeometry, defaults: [4, 1, 256, 128] },
