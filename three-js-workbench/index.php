...
foreach ( $ctrlsCfg->lights as $key=>$light ) {
    ...
    $lights .= "<label>
        ...
        <input type=\"range\" id=\"{$name}-slider\" min=\"0\" max=\"5\" step=\"0.5\" value=\"{$light->intensity}\" data-label=\"{$name}-lbl\" data-property=\"intensity\" data-type=\"{$light->type}\" data-index=\"lights\" autocomplete=\"off\" />
    </label>";
}
